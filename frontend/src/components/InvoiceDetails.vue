<script setup>
  ...
  const currency = ref(invoice.currency)
...
<template>
  ...
  <div class="form">
    <div class="field">
      ...
      <select v-model="currency" id="currencyDropdown">
        ...
        <option value="FOK">FOK - XFO Franc</option>
        ...
        <option value="KID">KID - KID Financ</option>
        ...
        <option value="LBP">LBP - LBP - Lebanese Pound</option>
